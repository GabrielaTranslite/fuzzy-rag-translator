...
def collections_creator(collection_name: str):
...
def points_inserter(tm: list, vectors: list, chunks: int, collection_name: str):
    ...
    print(f"{points_count} added to the collection")


def main():
    """Orchestration: creating collection > inserting points > building TM index"""
